...
// const friends = ["Chandler", "Sydney", "Joe"]

// function gamble() {
//     for(let i = 0, i < friends.length; i++)
//         console.log(friends.length[i])
// }

    // for(initialize variables, should one more time or not; any final code to run at end of loop)
        // console.log(friends.length[i])
